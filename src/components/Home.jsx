      ...
      <div className={pageWrapper}>
        ...
        <section className={section + " text-center"}>
          ...
          <p className={bodyText + " max-w-2xl mx-auto"}>
            A modern platform where authors share ideas and readers discover
            inspiring stories. Built for creativity, connection, and community.
          </p>
        ...
        <section className={section}>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            <div className={cardClass}>
              <h3 className="text-lg font-semibold mb-3">✍️ Write Your Own</h3>
              <p className={bodyText}>
        ...
        <section className={section}>
          ...
          <div className={articleGrid}>
            ...
            <div className={articleCardClass}>
              <h3 className={articleTitle}>Top 5 Writing Tips</h3>
              <p className={articleExcerpt}>
